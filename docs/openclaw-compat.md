...
16. Nächste: P4-01 Node-Sidecar-Plugin-Laufzeit; P4-07/P4-08 Automations (Goals & Queues, Background-Sessions); P4-11–P4-14 Browser/Talk/Voice aus 2026.8.2; **P4-02 Open Memory Vault** (Vault-Write/List ✅ **und Read-Back/Watcher-Sync ✅**; offen: semantisches Retrieval + Compaction-Trigger) + **P4-15 Shared Memory Pools**; **P4-16 Stable API** als Differenzierung zu OpenClaws breaking-change-Kultur.**
