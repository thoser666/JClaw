...
| **0.4.0** | Channels | P3-06 Weitere Channels (IRC ✅, Email ✅, Mattermost ✅, Google Chat ✅, Feishu ✅, Synology Chat ✅, X ✅), P3-07 Media-Message-Support, P3-08 Ingress-Monitor ✅, ~~P2-05~~ ✅ Control-UI | Nutzbares Multi-Plattform-Produkt |
...
1. **P3-06/P3-08** Weitere Channel-Adapter (**IRC ✅, Email ✅, Mattermost ✅, Google Chat ✅, Feishu ✅, Synology Chat ✅, X ✅**) — verbleibend: Buzz, ClickClack, … — und die **Ingress-Monitor-Abstraktion** aus dem OpenClaw-Plugin-SDK ist **umgesetzt (P3-08 ✅)**; Adapter können sie nutzen statt eigener Polling-Logik (künftig z. B. Beispiele: X-DM, Telegram, Email). Dabei **P3-07** Media-Message-Support berücksichtigen.
