...
| **0.4.0** | Channels | P3-06 Weitere Channels (IRC ✅, Email ✅, Mattermost ✅), P3-07 Media-Message-Support, P3-08 Ingress-Monitor, ~~P2-05~~ ✅ Control-UI | Nutzbares Multi-Plattform-Produkt |
...
1. **P3-06/P3-08** Weitere Channel-Adapter (**IRC ✅, Email ✅, Mattermost ✅**) — verbleibend: Buzz, ClickClack, Google Chat, Feishu, X, … — und die **Ingress-Monitor-Abstraktion** aus dem OpenClaw-Plugin-SDK nachbilden (durable admission, polling, pruning, claim-identity validation, adoption handoff, shutdown); dabei **P3-07** Media-Message-Support berücksichtigen.
