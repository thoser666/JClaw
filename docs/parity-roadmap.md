...
1. **P2-01/P2-02** Konfigurations-Refactoring (JSON5 + Schema-Validierung, Hot-Reload) — erster P2-Baustein für 0.2.0.
2. **P2-04** Gateway-Steuerung — Session-Gruppen, Thread-Bindings, generierte Titel, Transcript-Export (erweitert P1-09 um volle Session-first-Parität).
